# Benchmark: [11 kWe ORC waste-heat-recovery rig](https://github.com/karimialii/orc11kwe-benchmark)

`orc11kwe_benchmark.py` checks ThermoWave's closed loop against a
